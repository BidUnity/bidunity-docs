...
```javascript
{
    ...
    "parts": [PartObject],  // Array of Parts, see below for Part object
    "doors": [DoorObject],  // Array of Doors, see below for Door object
    "total_cost": 3820.48
}
```
...
The Part object can represent many different types of items, from items purchased individually, in a box, as a stock length, area, or volume. But no matter how the part is purchased, it has the same JSON object structure.
